...
import numpy as np
import pyquaternion
from nuscenes.utils.data_classes import Box as AirsimBox
...
class AirsimDataset(Custom3DDataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        if 'ann_infos' in info:
            gt_boxes, gt_labels = info['ann_infos']
            input_dict['ann_infos'] = (np.array(gt_boxes),np.array(gt_labels))
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(mmcv.track_iter_progress(results)):
            ...
            trans = self.data_infos[sample_id]['cams'][self.ego_cam]['ego2global_translation']
            rot = self.data_infos[sample_id]['cams'][self.ego_cam]['ego2global_rotation']
            ...
            for i, box in enumerate(boxes):
                ...
                nusc_box = AirsimBox(center, wlh, quat, velocity=box_vel)
                nusc_box.rotate(rot)
        ...
        res_path = osp.join(jsonfile_prefix, 'results_airsim.json')
...
def output_to_nusc_box(detection, with_velocity=True):
    ...
    Returns:
        list[:obj:`AirsimBox`]: List of standard AirsimBoxes.
    """
